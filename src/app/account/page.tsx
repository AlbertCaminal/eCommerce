        ...
        <div className="flex flex-col md:flex-row w-full max-w-7xl mx-auto">
          ...
          <aside className="w-full md:w-1/4 bg-white p-3 md:p-6 border-b md:border-b-0 md:border-r border-gray-200">
            <div className="bg-gray-100 p-3 md:p-4 rounded shadow-sm">
              ...
              <p className="text-gray-600 text-sm md:text-base">Al realizar una compra, puedes ganar más puntos</p>
            ...
            <div className="mt-4 md:mt-6 text-gray-700 text-sm md:text-base">
              ...
              <a href="#" className="text-red-500 hover:underline font-medium">Desconexión</a>
            </div>
          </aside>
          ...
          <section className="w-full md:w-3/4 bg-gray-100 p-3 md:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-6 mt-4 md:mt-6">
              <div className="bg-white p-3 md:p-4 text-center rounded shadow-sm">
                <p className="text-gray-700 font-medium text-sm md:text-base">OFERTAS Y DESCUENTOS ESPECIALES</p>
              </div>
              <div className="bg-white p-3 md:p-4 text-center rounded shadow-sm">
                <p className="text-gray-700 font-medium text-sm md:text-base">COMPRA Y OBTÉN PUNTOS CON CADA COMPRA</p>
              </div>
              <div className="bg-white p-3 md:p-4 text-center rounded shadow-sm">
                <p className="text-gray-700 font-medium text-sm md:text-base">DISFRUTA DE UN 10 % DE DTO. EN TU 1.ª COMPRA</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 md:gap-4 mt-4">
              <div className="text-center bg-white p-3 md:p-4 rounded shadow-sm">
                ...
                <p className="text-gray-700 font-medium text-sm md:text-base">Pantalones Cargo Cortes</p>
                <p className="text-gray-600 text-sm md:text-base">49.99 €</p>
              </div>
              <div className="text-center bg-white p-3 md:p-4 rounded shadow-sm">
                <img src="/images/item2.jpg" alt="Jeans" className="rounded mb-2" />
                <p className="text-gray-700 font-medium text-sm md:text-base">JIGLENN JJORGIGINAL SQ 223</p>
                <p className="text-gray-600 text-sm md:text-base">29.99 €</p>
              </div>
              <div className="text-center bg-white p-3 md:p-4 rounded shadow-sm">
                <img src="/images/item3.jpg" alt="Jeans" className="rounded mb-2" />
                <p className="text-gray-700 font-medium text-sm md:text-base">JIGLENN JJORGIGINAL SQ 270</p>
                <p className="text-gray-600 text-sm md:text-base">29.99 €</p>
              </div>
              <div className="text-center bg-white p-3 md:p-4 rounded shadow-sm">
                <img src="/images/item4.jpg" alt="Jeans" className="rounded mb-2" />
                <p className="text-gray-700 font-medium text-sm md:text-base">JIGLENN JJORGIGINAL SQ 349</p>
                <p className="text-gray-600 text-sm md:text-base">29.99 €</p>
              </div>
              <div className="text-center bg-white p-3 md:p-4 rounded shadow-sm">
                <img src="/images/item5.jpg" alt="Pantalones Cargo Junior" className="rounded mb-2" />
                <p className="text-gray-700 font-medium text-sm md:text-base">Pantalones Cargo Junior</p>
