        ...
        <section className="flex-1 mt-6 px-6 lg:px-6">
          ...
          <section className="relative mx-auto mb-6 max-w-[2050px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
              <div className="text-center text-white">
                ...
                <h2
                  className="
                    mb-4 font-bold transition-all duration-500
                    xxxs:text-xs
                    xxs:text-sm
                    xs:text-base
                    sm:text-lg
                    ...
                    lg:text-3xl
                    xl:text-5xl
                    sm:mb-2 xs:mb-1 xxs:mb-0 xxxs:mb-0
                  "
                >
                  Eleva Tu Estilo
                </h2>
                ...
                <Link
                  href="/shop"
                  className="
                    inline-block bg-white text-black transition-all duration-500 hover:bg-gray-200
                    xxxs:text-xxxs
                    xxs:text-xxs
                    xs:text-xs
                    sm:text-sm
          ...
          <section className="mx-auto max-w-[2050px] bg-gray-100 py-24">
            <div className="container mx-auto text-center">
              ...
              <p
                className="
                  mx-auto mt-10 max-w-xl text-gray-600
                  xxxs:text-xxxs
                  xxs:text-xxs
                  xs:text-sm
                  sm:text-md
                ...
                <div className="w-80 overflow-hidden bg-white shadow-lg">
                  ...
                  <div className="p-4">
                    ...
                    <a
                      href="#"
                      className="
                        mt-4 inline-block bg-black px-4 py-2 text-white hover:bg-gray-800
                        xxxs:text-xxxs
                        xxs:text-xxs
                        xs:text-xs
                        sm:text-sm
